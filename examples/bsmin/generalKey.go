...
func NewGeneralKey(rotIndex int, keyLevel int, maxMultLevel int, params *ckks.Parameters) *GeneralKey {
...
func (obj GeneralKey) GetKeySize() int {
	uint64Size := 8 //byte
	N := obj.N
	L := obj.MaxMultLevel
	K := obj.K
...
func (obj GeneralKey) PrintKeyInfo() {
...
func GenLevelUpKey(preLevelKey *GeneralKey, newHdnum float64) *GeneralKey {
	logPQbound := 1792
